	...
	var javaex = function() {
		...
		var info = {
			...
			select : function(args) {
				...
				let lastY = 0;	// 上一次触摸时的Y坐标
				let nowElement = null;	// 当前滚动的ul
				let liLength = 0;		// 当前滚动的ul下的li数量
				let nY = 0;
				let mY = 0;
				let endY = 0;
				let maxY = 0;
				...
				// 绑定滚动事件
				let oScroll = document.getElementById("mask-data-"+selectId);
